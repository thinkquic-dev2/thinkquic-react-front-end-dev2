...
const AgTable = ({ uploadedJsonFile, onGridReady, onColumnVisible, display, setDisplay, uploadFileInputRef }) => {
  ...
  const isUploadEnabled = uploadFileInputRef.current && uploadFileInputRef.current.files.length > 0 ? true : false;
